...
<body class="gray-bg">
<img src="plug-in/login/images/index.png" style="width:75%;">
<!-- <iframe src="http://www.sunyard.com" style = "width: -webkit-fill-available;height: -webkit-fill-available;" ></iframe> -->
