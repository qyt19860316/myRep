...
import org.sunnyframework.web.system.sms.entity.TSSmsSqlEntity;
import org.sunnyframework.web.system.sms.service.TSSmsSqlServiceI;
...
public class TSSmsSqlController extends BaseController {
	...
	public void datagrid(TSSmsSqlEntity tSSmsSql,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsSql, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
