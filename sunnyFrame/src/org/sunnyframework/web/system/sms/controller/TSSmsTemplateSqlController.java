package org.sunnyframework.web.system.sms.controller;
...
import org.sunnyframework.web.system.sms.entity.TSSmsTemplateSqlEntity;
import org.sunnyframework.web.system.sms.service.TSSmsTemplateSqlServiceI;
import org.sunnyframework.web.system.sms.util.TuiSongMsgUtil;
...
public class TSSmsTemplateSqlController extends BaseController {
	...
	public void datagrid(TSSmsTemplateSqlEntity tSSmsTemplateSql,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tSSmsTemplateSql, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
