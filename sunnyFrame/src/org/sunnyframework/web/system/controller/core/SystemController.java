package org.sunnyframework.web.system.controller.core;
...
import org.sunnyframework.core.common.controller.BaseController;
import org.sunnyframework.core.common.dao.jdbc.JdbcDao;
import org.sunnyframework.core.common.hibernate.qbc.CriteriaQuery;
import org.sunnyframework.core.common.model.common.UploadFile;
import org.sunnyframework.core.common.model.json.AjaxJson;
import org.sunnyframework.core.common.model.json.ComboTree;
import org.sunnyframework.core.common.model.json.DataGrid;
import org.sunnyframework.core.common.model.json.TreeGrid;
import org.sunnyframework.core.common.model.json.ValidForm;
import org.sunnyframework.core.constant.Globals;
import org.sunnyframework.core.extend.hqlsearch.parse.ObjectParseUtil;
import org.sunnyframework.core.extend.hqlsearch.parse.PageValueConvertRuleEnum;
import org.sunnyframework.core.extend.hqlsearch.parse.vo.HqlRuleEnum;
import org.sunnyframework.core.util.DateUtils;
import org.sunnyframework.core.util.JSONHelper;
import org.sunnyframework.core.util.ListUtils;
import org.sunnyframework.core.util.MutiLangSqlCriteriaUtil;
import org.sunnyframework.core.util.MutiLangUtil;
import org.sunnyframework.core.util.MyClassLoader;
import org.sunnyframework.core.util.ResourceUtil;
import org.sunnyframework.core.util.SetListSort;
import org.sunnyframework.core.util.StringUtil;
import org.sunnyframework.core.util.YouBianCodeUtil;
import org.sunnyframework.core.util.oConvertUtils;
import org.sunnyframework.tag.core.easyui.TagUtil;
import org.sunnyframework.tag.vo.datatable.SortDirection;
import org.sunnyframework.tag.vo.easyui.ComboTreeModel;
import org.sunnyframework.tag.vo.easyui.TreeGridModel;
import org.sunnyframework.web.system.manager.ClientManager;
import org.sunnyframework.web.system.manager.ClientSort;
import org.sunnyframework.web.system.pojo.base.Client;
import org.sunnyframework.web.system.pojo.base.DataLogDiff;
import org.sunnyframework.web.system.pojo.base.TSDatalogEntity;
import org.sunnyframework.web.system.pojo.base.TSDepart;
import org.sunnyframework.web.system.pojo.base.TSDocument;
...
import org.sunnyframework.web.system.pojo.base.TSVersion;
import org.sunnyframework.web.system.service.MutiLangServiceI;
...
//			depart.setOrgCode(orgCode);
    ...
    public void dataLogDatagrid(TSDatalogEntity datalogEntity,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid){
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, datalogEntity, request.getParameterMap());
		cq.add();
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
    }
