...
import org.sunnyframework.core.timer.DynamicTask;
...
import org.sunnyframework.web.system.pojo.base.TSTimeTaskEntity;
...
public class TimeTaskController extends BaseController {
	...
	public void datagrid(TSTimeTaskEntity timeTask,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, timeTask, request.getParameterMap());
