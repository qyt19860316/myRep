...
import org.sunnyframework.core.util.LogUtil;
import org.sunnyframework.core.util.MutiLangUtil;
import org.sunnyframework.core.util.MyBeanUtils;
import org.sunnyframework.core.util.NumberComparator;
...
import org.sunnyframework.web.system.pojo.base.TSRoleOrg;
...
public class RoleController extends BaseController {
	...
	public void roleGrid(TSRole role, HttpServletRequest request,
		...
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq,
				role);
		cq.add();
...
//      systemService.addLog(message, Globals.Log_Type_UPDATE, Globals.Log_Leavel_INFO);
	...
	public String exportXls(TSRole tsRole,HttpServletRequest request,HttpServletResponse response
		...
		CriteriaQuery cq = new CriteriaQuery(TSRole.class, dataGrid);
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsRole, request.getParameterMap());
