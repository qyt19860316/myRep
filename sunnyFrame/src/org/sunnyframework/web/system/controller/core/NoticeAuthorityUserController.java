...
import org.sunnyframework.web.system.pojo.base.TSNoticeAuthorityUser;
import org.sunnyframework.web.system.service.NoticeAuthorityUserServiceI;
...
public class NoticeAuthorityUserController extends BaseController {
	...
	public void datagrid(TSNoticeAuthorityUser noticeAuthorityUser,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, noticeAuthorityUser, request.getParameterMap());
		try{
		//自定义追加查询条件
		}catch (Exception e) {
