...
import org.sunnyframework.web.system.pojo.base.MutiLangEntity;
...
public class MutiLangController extends BaseController {
	...
	public void datagrid(MutiLangEntity mutiLang, HttpServletRequest request,
		...
		// 查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, mutiLang, request.getParameterMap());
