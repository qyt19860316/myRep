...
import org.sunnyframework.core.common.model.json.ComboBox;
...
import org.sunnyframework.core.enums.SysThemesEnum;
import org.sunnyframework.core.util.ExceptionUtil;
import org.sunnyframework.core.util.ListtoMenu;
import org.sunnyframework.core.util.MyBeanUtils;
import org.sunnyframework.core.util.PasswordUtil;
import org.sunnyframework.core.util.ResourceUtil;
import org.sunnyframework.core.util.RoletoJson;
import org.sunnyframework.core.util.SetListSort;
import org.sunnyframework.core.util.StringUtil;
import org.sunnyframework.core.util.SysThemesUtil;
import org.sunnyframework.core.util.oConvertUtils;
import org.sunnyframework.tag.core.easyui.TagUtil;
import org.sunnyframework.tag.vo.datatable.DataTableReturn;
import org.sunnyframework.tag.vo.datatable.DataTables;
...
//			}
	...
	public void datagrid(TSUser user,HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
        ...
        //查询条件组装器
        org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, user);
...
//				}
	...
	public void datagridRole(TSRole tsRole, HttpServletRequest request, HttpServletResponse response, DataGrid dataGrid) {
		...
		//查询条件组装器
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsRole);
		this.systemService.getDataGridReturn(cq, true);
		TagUtil.datagrid(response, dataGrid);
	}
...
//			}
	...
	public String exportXls(TSUser tsUser,HttpServletRequest request,HttpServletResponse response
		...
		CriteriaQuery cq = new CriteriaQuery(TSUser.class, dataGrid);
		org.sunnyframework.core.extend.hqlsearch.HqlGenerateUtil.installHql(cq, tsUser, request.getParameterMap());
