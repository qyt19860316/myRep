package org.sunnyframework.tag.core.easyui;
...
import org.sunnyframework.tag.vo.easyui.ColumnValue;
import org.sunnyframework.tag.vo.easyui.DataGridColumn;
import org.sunnyframework.tag.vo.easyui.DataGridUrl;
import org.sunnyframework.tag.vo.easyui.OptTypeDirection;
...
//				}
	...
	public String getNoAuthOperButton(){
		...
		//org.sunnyframework.core.util.LogUtil.info("----getNoAuthOperButton-------"+sb.toString());
		return sb.toString(); 
	}
