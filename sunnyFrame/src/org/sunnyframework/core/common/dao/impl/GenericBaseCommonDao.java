package org.sunnyframework.core.common.dao.impl;
...
import org.sunnyframework.core.annotation.JeecgEntityTitle;
import org.sunnyframework.core.common.dao.IGenericBaseCommonDao;
import org.sunnyframework.core.common.dao.jdbc.JdbcDao;
import org.sunnyframework.core.common.exception.BusinessException;
import org.sunnyframework.core.common.hibernate.qbc.CriteriaQuery;
import org.sunnyframework.core.common.hibernate.qbc.DetachedCriteriaUtil;
import org.sunnyframework.core.common.hibernate.qbc.HqlQuery;
import org.sunnyframework.core.common.hibernate.qbc.PageList;
import org.sunnyframework.core.common.hibernate.qbc.PagerUtil;
import org.sunnyframework.core.common.model.common.DBTable;
import org.sunnyframework.core.common.model.json.DataGridReturn;
import org.sunnyframework.core.util.MyBeanUtils;
import org.sunnyframework.core.util.StringUtil;
import org.sunnyframework.core.util.ToEntityUtil;
...
public abstract class GenericBaseCommonDao<T, PK extends Serializable>
	...
	private <T> void getProperty(Class entityName) {
		...
		for (int i = 0; i < str.length; i++) {
			...
			org.sunnyframework.core.util.LogUtil.info(property + "---&gt;" + type);
		}
	}
