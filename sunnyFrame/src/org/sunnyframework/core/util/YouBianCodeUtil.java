...
//			 org.sunnyframework.core.util.LogUtil.info(after_code);
//			 org.sunnyframework.core.util.LogUtil.info(after_code_zimu);
//			 org.sunnyframework.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// org.sunnyframework.core.util.LogUtil.info(getNextZiMu('C'));
		// org.sunnyframework.core.util.LogUtil.info(getNextNum(8));
		org.sunnyframework.core.util.LogUtil.info(getSubYouBianCode("C99A01","B03"));
//		org.sunnyframework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
