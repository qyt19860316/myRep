package org.sunnyframework.core.util;
...
import org.sunnyframework.core.def.ConstantsDefs;
...
public class JeecgSqlUtil {
	...
	private static String getFlieTxt(String fileUrl) {
		org.sunnyframework.core.util.LogUtil.info("---------------------------------------sql 路径 :"+fileUrl);
		String sql = null;
		try {
	...
	public static String getMethodSqlLogic(String methodUrl){
		...
		org.sunnyframework.core.util.LogUtil.info(sqlurl);
...
//		org.sunnyframework.core.util.LogUtil.info(projectPath);
//		String projectPath =  request.getSession().getServletContext().getRealPath("/");
	...
	public static String getAppPath(Class cls) {
		...
		org.sunnyframework.core.util.LogUtil.info("realPath----->"+realPath);
		return realPath;
	}
	...
	public static void main(String[] args) {
		//org.sunnyframework.core.util.LogUtil.info(getAppPath(JeecgSqlUtil.class));
		org.sunnyframework.core.util.LogUtil.info(getCountSqlBySql("SELECT * 	from JEECG_DICT_PARAM WHERE 1=1"));
	}
